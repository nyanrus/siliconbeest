...
app.get('/', async (c) => {
  ...
  if (adminRow) {
    contactAccount = {
      ...
      avatar: (adminRow.avatar_url as string) || '',
      avatar_static: (adminRow.avatar_static_url as string) || '',
      header: (adminRow.header_url as string) || '',
      header_static: (adminRow.header_static_url as string) || '',
